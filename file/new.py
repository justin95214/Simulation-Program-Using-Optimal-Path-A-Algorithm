...
def route(temp_df, df_element,day, current_point):
	...
	Max_distance_row_point = temp_df.iloc[0]['code']
	total_distance = total_distance + temp_df.iloc[0][current_point+'_운행거리']
	temp_df.loc[(temp_df['code']==Max_distance_row_point),'stopby']=1
	...
	temp_df, trace_list, total_distance = after_first_time(temp_df, day, current_point, trace_list ,total_distance, left_kappa, left_drive_time, average_speed, get_up, get_off)
